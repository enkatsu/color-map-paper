...
たとえば，深緋という\colorname{}が，「深」と「緋」の二つの漢字から構成されていることに注目すると，
...
\begin{figure}[htbp]
  \includegraphics[width=8cm,clip]{fig/kanji-color-space.eps}
  \caption{No.1}
  \label{no1}
\end{figure}

\begin{figure}[htbp]
  \includegraphics[width=8cm,clip]{fig/kanji-color-graph.eps}
  \caption{No.2}
  \label{no2}
\end{figure}

\begin{figure}[htbp]
  \includegraphics[width=8cm,clip]{fig/kanji-circle-color-graph.eps}
  \caption{No.3}
  \label{no3}
\end{figure}
