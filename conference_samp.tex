...
\begin{figure*}[h]
 ...
 \begin{minipage}{0.3\hsize}
  \begin{center}
   \includegraphics[width=5.5cm]{fig/kanji-color-space.eps}
  \end{center}
  \caption{No.1}
  \label{fig:no1}
 \end{minipage}
 \begin{minipage}{0.3\hsize}
 \begin{center}
  \includegraphics[width=5.5cm]{fig/kanji-color-graph.eps}
 \end{center}
  \caption{No.2}
  \label{fig:no2}
 \end{minipage}
 \begin{minipage}{0.3\hsize}
 \begin{center}
  \includegraphics[width=5.5cm]{fig/kanji-circle-color-graph.eps}
 \end{center}
  \caption{No.3}
  \label{fig:no3}
 \end{minipage}
